...
public class RoutineHistoryExerciseSets extends BaseEntity {
    ...
    @Builder
    private RoutineHistoryExerciseSets(Long id, RoutineHistoryExercise routineHistoryExercise, int orderIndex, int reps, double weight, int exerciseTime, int refreshTime) {
        this.id = id;
