...
public class Member extends BaseEntity {
	...
	@Builder
	private Member(String id, String provider, String providerId, String email, String masking_email, String nickname,
			String bio, String profileImage, MemberRole role, MemberStatus status) {
		this.id = id;
	...
	public static Member of(String memberId, MemberRole role) {
		return Member.builder().id(memberId).role(role).build();
	}
