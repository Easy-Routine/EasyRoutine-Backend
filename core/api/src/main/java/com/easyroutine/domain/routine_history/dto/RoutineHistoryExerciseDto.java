...
public class RoutineHistoryExerciseDto {
	...
	public static RoutineHistoryExerciseDto createOf(RoutineHistoryExerciseCreateRequest request) {
		List<RoutineHistorySetsDto> sets = request.getSets().stream().map(RoutineHistorySetsDto::createOf).toList();

		return RoutineHistoryExerciseDto.builder()
			.exercise(RoutineHistoryExerciseDetailDto.createOf(request.getExercise().getId(), null))
	...
	public static RoutineHistoryExerciseDto of(RoutineHistoryExercise routineHistoryExercise) {
		List<RoutineHistorySetsDto> sets = routineHistoryExercise.getRoutineHistoryExerciseSets()
			.stream()
		...
		return RoutineHistoryExerciseDto.builder()
			...
			.exercise(RoutineHistoryExerciseDetailDto.createOf(routineHistoryExercise))
